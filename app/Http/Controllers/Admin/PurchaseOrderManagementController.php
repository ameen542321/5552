...
class PurchaseOrderManagementController extends Controller
{
    ...
    public function index(Request $request, PurchaseOrderLimitService $limits)
    {
        $validated = $request->validate([
            ...
            'store_id.integer' => 'معرف المتجر المحدد غير صحيح.',
            'store_id.exists' => 'المتجر المحدد غير موجود.',
            'status.in' => 'الحالة العامة المحددة غير صحيحة.',
            'workflow_status.in' => 'مرحلة سير العمل المحددة غير صحيحة.',
            'date_from.date' => 'تاريخ بداية التقرير غير صحيح.',
            'date_to.date' => 'تاريخ نهاية التقرير غير صحيح.',
            'date_to.after_or_equal' => 'يجب أن يكون تاريخ النهاية مساويًا لتاريخ البداية أو بعده.',
            'search.string' => 'يجب أن يكون نص البحث صالحًا.',
            'search.max' => 'يجب ألا يتجاوز البحث 100 حرف.',
        ]);
    ...
    private function validateLimit(Request $request, bool $allowException): array
    {
        ...
        return $request->validate([
            ...
            'weekly_limit.required' => 'أدخل الحد الأسبوعي للطلبيات.',
            'weekly_limit.integer' => 'يجب أن يكون الحد الأسبوعي عددًا صحيحًا.',
            'weekly_limit.min' => 'يجب ألا يقل الحد الأسبوعي عن طلبية واحدة.',
            'weekly_limit.max' => 'يجب ألا يزيد الحد الأسبوعي على 100 طلبية.',
            'store_id.required' => 'اختر المتجر.',
            'store_id.prohibited' => 'لا يرسل متجر عند تعديل الإعداد العام.',
            'store_id.exists' => 'المتجر المحدد غير موجود.',
            'counted_statuses.required' => 'اختر حالة واحدة على الأقل للاحتساب.',
            'counted_statuses.array' => 'حالات الاحتساب المرسلة غير صحيحة.',
            'counted_statuses.min' => 'اختر حالة واحدة على الأقل للاحتساب.',
            'counted_statuses.*.in' => 'إحدى حالات الاحتساب المحددة غير صحيحة.',
            'exception_weekly_limit.integer' => 'يجب أن يكون حد الاستثناء عددًا صحيحًا.',
            'exception_weekly_limit.min' => 'يجب ألا يقل حد الاستثناء عن طلبية واحدة.',
            'exception_weekly_limit.max' => 'يجب ألا يزيد حد الاستثناء على 100 طلبية.',
            'exception_expires_at.required_with' => 'حدد وقت انتهاء الاستثناء المؤقت.',
            'exception_expires_at.date' => 'وقت انتهاء الاستثناء غير صحيح.',
            'exception_expires_at.after' => 'يجب أن يكون انتهاء الاستثناء في وقت لاحق.',
            'exception_reason.required_with' => 'اكتب سبب الاستثناء المؤقت.',
            'exception_reason.min' => 'يجب ألا يقل سبب الاستثناء عن 10 أحرف.',
            'exception_reason.max' => 'يجب ألا يتجاوز سبب الاستثناء 500 حرف.',
        ]);
    }
