...
class PurchaseOrderLimitSetting extends Model
{
    ...
    protected $fillable = [
        'store_id', 'is_global', 'weekly_limit', 'counted_statuses', 'exception_weekly_limit',
    ...
    public function effectiveCountedStatuses(): array
    {
        ...
        // لا نسمح لإعداد قديم أو تالف بتعطيل الحارس الأسبوعي كليًا.
        return $statuses !== [] ? $statuses : self::DEFAULT_COUNTED_STATUSES;
    }
}
