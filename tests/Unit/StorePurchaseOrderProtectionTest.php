...
class StorePurchaseOrderProtectionTest extends TestCase
{
    ...
    public function test_invalid_empty_counted_statuses_fall_back_to_safe_defaults(): void
    {
        $setting = new PurchaseOrderLimitSetting(['counted_statuses' => ['legacy_unknown_status']]);

        $this->assertSame(PurchaseOrderLimitSetting::DEFAULT_COUNTED_STATUSES, $setting->effectiveCountedStatuses());
    }
