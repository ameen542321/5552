...
document.addEventListener('click', (event) => {
    ...
    const notesTarget = modal.querySelector('[data-owner-credit-preview-value="notes"]');
    const notesRow = modal.querySelector('[data-owner-credit-preview-notes]');
    ...
    if (notesTarget) notesTarget.textContent = notes || '—';
