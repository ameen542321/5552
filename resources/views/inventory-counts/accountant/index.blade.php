...
@section('content')
<div class="max-w-5xl mx-auto space-y-5"><div><h1 class="ui-title text-2xl font-bold">مهام الجرد</h1><p class="ui-text-soft">أدخل الكمية الفعلية دون عرض كمية النظام.</p></div><x-ui.card>
