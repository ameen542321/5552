...
<div class="max-w-6xl mx-auto space-y-5">
    ...
    <div class="ui-alert ui-alert-warning" role="status">
        <strong>تنبيه اختبار مؤقت:</strong>
        تم إيقاف شرط اختيار خمسة منتجات مؤقتًا، ويسمح الآن بإنشاء جلسة من منتج واحد. يجب إعادة الحد الأدنى إلى خمسة منتجات بعد انتهاء التجربة الواقعية.
    </div>
    <x-ui.card>
